defmodule TwitterWeb.PostLiveTest do
  ...
  @create_attrs %{content: "some content", likes_count: 42, reposts_count: 42, username: "some username"}
  @update_attrs %{content: "some updated content", likes_count: 43, reposts_count: 43, username: "some updated username"}
  @invalid_attrs %{content: nil, likes_count: nil, reposts_count: nil, username: nil}
